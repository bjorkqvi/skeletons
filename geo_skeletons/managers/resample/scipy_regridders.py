...
def scipy_point_to_gridded(data, new_grid, new_data, method: str ='nearest'):
    """Uses a simple scipy griddata to regrid gridded data to gridded data.
...
scipy_regridders = {'gridded_to_gridded': scipy_gridded_to_gridded,'point_to_gridded': scipy_point_to_gridded}