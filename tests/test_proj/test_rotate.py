...
def test_ww3_4km():
    ...
    pm = ProjManager(metadata_manager=None, crs=proj4, lon=(None, None), lat=(None, None))
...
def test_meps():
    ...
    pm = ProjManager(metadata_manager=None, crs=crs_metadata, lon=(None, None), lat=(None, None))
...
def test_utm():
    ...
    pm = ProjManager(metadata_manager=None, crs=32632, lon=(None, None), lat=(None, None))
