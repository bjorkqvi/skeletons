...
def test_empty_core_not_strict(wave_no_std, wave_std):
    data = PointSkeleton(lon=0, lat=0)
    core_vars, core_coords, coords_needed, __ = identify_core_in_ds(data.core, ds=wave_no_std.ds(), strict=False)

def test_empty_core_specify_missing(wave_no_std, wave_std):
    data = PointSkeleton(lon=0, lat=0)
    core_vars, core_coords, coords_needed, __ = identify_core_in_ds(data.core, ds=wave_no_std.ds(), allowed_misses=['lon','lat'])
